...
COMBATANT_ALLIES_NUMBER: equ $20
...
COMBATANT_OFFSET_HP_BASE: equ $10
COMBATANT_OFFSET_MP_MAX: equ $12
COMBATANT_OFFSET_MP_CURRENT: equ $14
COMBATANT_OFFSET_MP_BASE: equ $16
COMBATANT_OFFSET_ATT_TOTAL: equ $18
COMBATANT_OFFSET_ATT_BASE: equ $19
COMBATANT_OFFSET_ATT_CURRENT: equ $1A
COMBATANT_OFFSET_DEF_TOTAL: equ $1B
COMBATANT_OFFSET_DEF_BASE: equ $1C
COMBATANT_OFFSET_DEF_CURRENT: equ $1D
COMBATANT_OFFSET_AGI_TOTAL: equ $1E
COMBATANT_OFFSET_AGI_BASE: equ $1F
COMBATANT_OFFSET_AGI_CURRENT: equ $20
COMBATANT_OFFSET_MOV_BASE: equ $21
COMBATANT_OFFSET_MOV_CURRENT: equ $22
COMBATANT_OFFSET_SPACER: equ $23
COMBATANT_OFFSET_RESIST_BASE: equ $24
COMBATANT_OFFSET_RESIST_BASE_LOW_BYTE: equ $25
COMBATANT_OFFSET_RESIST_CURRENT: equ $26
COMBATANT_OFFSET_PROWESS_BASE: equ $28
COMBATANT_OFFSET_PROWESS_CURRENT: equ $29
COMBATANT_OFFSET_ITEMS: equ $2A
COMBATANT_OFFSET_ITEM_0: equ $2A
COMBATANT_OFFSET_ITEM_1: equ $2C
COMBATANT_OFFSET_ITEM_2: equ $2E
COMBATANT_OFFSET_ITEM_3: equ $30
COMBATANT_OFFSET_SPELLS: equ $32
COMBATANT_OFFSET_SPELLS_END: equ $36
COMBATANT_OFFSET_STATUSEFFECTS: equ $36
COMBATANT_OFFSET_X: equ $38
COMBATANT_OFFSET_Y: equ $39
COMBATANT_OFFSET_EXP: equ $3A
COMBATANT_OFFSET_MOVETYPE_AND_AI: equ $3B
COMBATANT_OFFSET_ALLY_KILLS: equ $3C
COMBATANT_OFFSET_AI_SPECIAL_MOVE_ORDERS: equ $3C
COMBATANT_OFFSET_AI_ACTIVATION_FLAG: equ $3E
COMBATANT_OFFSET_ALLY_DEFEATS: equ $40
COMBATANT_OFFSET_AI_REGION: equ $40
COMBATANT_OFFSET_ENEMY_INDEX: equ $41
...
SORCEROR_SPELLSLOTS_COUNTER: equ 3
COMBATANT_ITEMSLOTS: equ $4
COMBATANT_SPELLSLOTS: equ $4
COMBATANT_ENTRY_SIZE: equ $42
COMBATANT_ENTRY_COUNTER: equ $41
...
STATUS_NOT_STUN: equ $FF-STATUSEFFECT_STUN
STATUS_NOT_POISON: equ $FF-STATUSEFFECT_POISON
STATUS_NOT_CURSE: equ $FF-STATUSEFFECT_CURSE
STATUS_NOT_MUDDLE2: equ $FF-STATUSEFFECT_MUDDLE2
STATUS_NOT_MUDDLE: equ $FF-STATUSEFFECT_MUDDLE
STATUS_NOT_SLEEP: equ $FF-STATUSEFFECT_SLEEP
STATUS_NOT_SILENCE: equ $FF-STATUSEFFECT_SILENCE
STATUS_NOT_SLOW: equ $FF-STATUSEFFECT_SLOW
STATUS_NOT_ATTACK: equ $FF-STATUSEFFECT_ATTACK
STATUS_NOT_BOOST: equ $FF-STATUSEFFECT_BOOST
...
; enum CharDef
CHAR_CLASS_LASTNONPROMOTED: equ $1F
CHAR_CLASS_FIRSTPROMOTED: equ $20
CHAR_CLASS_EXTRALEVEL: equ $14
CHAR_STATGAIN_PROJECTIONLEVEL: equ $1E
CHAR_LEVELCAP_BASE: equ $28
CHAR_LEVELCAP_PROMOTED: equ $63
CHAR_STATCAP_AGI_BASE: equ $FF
CHAR_STATCAP_AGI_CURRENT: equ $FF
CHAR_STATCAP_LEVEL: equ $FF
CHAR_STATCAP_HP: equ $FFF
CHAR_STATCAP_MP: equ $FFF
CHAR_STATCAP_ATT: equ $FF
CHAR_STATCAP_DEF: equ $FF
CHAR_STATCAP_MOV: equ $FF
CHAR_STATCAP_EXP: equ $FF
CHAR_STATCAP_AGI_DECREASING: equ $C8

; ---------------------------------------------------------------------------

; enum BattleTurnProperties
TWO_TURN_THRESHOLD: equ $7F
FIRST_TURN_SCALE: equ $10-SECOND_TURN_SCALE
SECOND_TURN_SCALE: equ $4
SECOND_TURN_START: equ TWO_TURN_THRESHOLD*FIRST_TURN_SCALE
...
RESISTANCE_WATER_WEAKNESS: equ $0
RESISTANCE_WATER_NONE: equ $1
RESISTANCE_WATER_MINOR: equ $2
RESISTANCE_WATER_MAJOR: equ $3
...
RESISTANCE_WIND_NONE: equ $100
RESISTANCE_WIND_MINOR: equ $200
RESISTANCE_WIND_MAJOR: equ $300
RESISTANCE_EARTH_WEAKNESS: equ $0
RESISTANCE_EARTH_NONE: equ $400
RESISTANCE_EARTH_MINOR: equ $800
RESISTANCE_EARTH_MAJOR: equ $C00
RESISTANCE_NEUTRAL_WEAKNESS: equ $0
RESISTANCE_NEUTRAL_NONE: equ $1000
RESISTANCE_NEUTRAL_MINOR: equ $2000
RESISTANCE_NEUTRAL_MAJOR: equ $3000
...
RESISTANCEENTRY_MASK_ALL: equ $FFFF
...
MOVETYPE_LOWER_14: equ $D
MOVETYPE_LOWER_15: equ $E
MOVETYPE_LOWER_16: equ $F
...
MOVETYPE_UPPER_14: equ $D0
MOVETYPE_UPPER_15: equ $E0
MOVETYPE_UPPER_16: equ $F0

; ---------------------------------------------------------------------------

; enum MoveTypeProperties
MOVETYPE_TOTAL: equ $10
...
CRITICAL_HIT_DAMAGE_FACTOR_1: equ 2
CRITICAL_HIT_DAMAGE_FACTOR_2: equ 1
...
CLASS_THIF: equ $A
CLASS_TORT: equ $B
CLASS_UNPRO13: equ $C   ; YGRT
CLASS_UNPRO14: equ $D   ; SKNT
CLASS_UNPRO15: equ $E   ; MONK
CLASS_UNPRO16: equ $F   ; ASKT
CLASS_UNPRO17: equ $10  ; WKNT
CLASS_UNPRO18: equ $11  ; DRGN
CLASS_UNPRO19: equ $12  ; 
CLASS_UNPRO20: equ $13  ; 
CLASS_UNPRO21: equ $14
CLASS_UNPRO22: equ $15
CLASS_UNPRO23: equ $16
CLASS_UNPRO24: equ $17
CLASS_UNPRO25: equ $18
CLASS_UNPRO26: equ $19
CLASS_UNPRO27: equ $1A
CLASS_UNPRO28: equ $1B
CLASS_UNPRO29: equ $1C
CLASS_UNPRO30: equ $1D
CLASS_UNPRO31: equ $1E
CLASS_UNPRO32: equ $1F
...
CLASS_GLM: equ $2D
CLASS_RDBN: equ $2E
CLASS_PROMO16: equ $2F                 ; SAMR
CLASS_PROMO17: equ CLASS_UNPRO17+$20  ; SBRN
CLASS_PROMO18: equ CLASS_UNPRO18+$20  ; SKNT
CLASS_PROMO19: equ CLASS_UNPRO19+$20  ; SKYL
CLASS_PROMO20: equ CLASS_UNPRO20+$20  ; GRDR
CLASS_PROMO21: equ CLASS_UNPRO21+$20  ; CYBG
CLASS_PROMO22: equ CLASS_UNPRO22+$20  ; MGCR
CLASS_PROMO23: equ CLASS_UNPRO23+$20
CLASS_PROMO24: equ CLASS_UNPRO24+$20
CLASS_PROMO25: equ CLASS_UNPRO25+$20
CLASS_PROMO26: equ CLASS_UNPRO26+$20
CLASS_PROMO27: equ CLASS_UNPRO27+$20
CLASS_PROMO28: equ CLASS_UNPRO28+$20
CLASS_PROMO29: equ CLASS_UNPRO29+$20
CLASS_PROMO30: equ CLASS_UNPRO30+$20
CLASS_PROMO31: equ CLASS_UNPRO31+$20
CLASS_PROMO32: equ CLASS_UNPRO32+$20

CLASS_MMNK: equ CLASS_SDMN+$40
CLASS_ITEM1_02: equ CLASS_KNTE+$40
CLASS_ITEM1_03: equ CLASS_WARR+$40
CLASS_ITEM1_04: equ CLASS_MAGE+$40
CLASS_ITEM1_05: equ CLASS_PRST+$40
CLASS_ITEM1_06: equ CLASS_ACHR+$40
CLASS_ITEM1_07: equ CLASS_BDMN+$40
CLASS_ITEM1_08: equ CLASS_WFMN+$40
CLASS_ITEM1_09: equ CLASS_RNGR+$40
CLASS_ITEM1_10: equ CLASS_PHNK+$40
CLASS_ITEM1_11: equ CLASS_THIF+$40
CLASS_ITEM1_12: equ CLASS_TORT+$40
CLASS_ITEM1_13: equ CLASS_UNPRO13+$40
CLASS_ITEM1_14: equ CLASS_UNPRO14+$40
CLASS_ITEM1_15: equ CLASS_UNPRO15+$40
CLASS_ITEM1_16: equ CLASS_UNPRO16+$40

CLASS_PGNT: equ CLASS_SDMN+$50
CLASS_ITEM2_02: equ CLASS_KNTE+$50
CLASS_ITEM2_03: equ CLASS_WARR+$50
CLASS_ITEM2_04: equ CLASS_MAGE+$50
CLASS_ITEM2_05: equ CLASS_PRST+$50
CLASS_ITEM2_06: equ CLASS_ACHR+$50
CLASS_ITEM2_07: equ CLASS_BDMN+$50
CLASS_ITEM2_08: equ CLASS_WFMN+$50
CLASS_ITEM2_09: equ CLASS_RNGR+$50
CLASS_ITEM2_10: equ CLASS_PHNK+$50
CLASS_ITEM2_11: equ CLASS_THIF+$50
CLASS_ITEM2_12: equ CLASS_TORT+$50
CLASS_ITEM2_13: equ CLASS_UNPRO13+$50
CLASS_ITEM2_14: equ CLASS_UNPRO14+$50
CLASS_ITEM2_15: equ CLASS_UNPRO15+$50
CLASS_ITEM2_16: equ CLASS_UNPRO16+$50

CLASS_BRN: equ CLASS_SDMN+$60
CLASS_ITEM3_02: equ CLASS_KNTE+$60
CLASS_ITEM3_03: equ CLASS_WARR+$60
CLASS_ITEM3_04: equ CLASS_MAGE+$60
CLASS_ITEM3_05: equ CLASS_PRST+$60
CLASS_ITEM3_06: equ CLASS_ACHR+$60
CLASS_ITEM3_07: equ CLASS_BDMN+$60
CLASS_ITEM3_08: equ CLASS_WFMN+$60
CLASS_ITEM3_09: equ CLASS_RNGR+$60
CLASS_ITEM3_10: equ CLASS_PHNK+$60
CLASS_ITEM3_11: equ CLASS_THIF+$60
CLASS_ITEM3_12: equ CLASS_TORT+$60
CLASS_ITEM3_13: equ CLASS_UNPRO13+$60
CLASS_ITEM3_14: equ CLASS_UNPRO14+$60
CLASS_ITEM3_15: equ CLASS_UNPRO15+$60
CLASS_ITEM3_16: equ CLASS_UNPRO16+$60

CLASS_SORC: equ CLASS_SDMN+$70
CLASS_ITEM4_02: equ CLASS_KNTE+$70
CLASS_ITEM4_03: equ CLASS_WARR+$70
CLASS_ITEM4_04: equ CLASS_MAGE+$70
CLASS_ITEM4_05: equ CLASS_PRST+$70
CLASS_ITEM4_06: equ CLASS_ACHR+$70
CLASS_ITEM4_07: equ CLASS_BDMN+$70
CLASS_ITEM4_08: equ CLASS_WFMN+$70
CLASS_ITEM4_09: equ CLASS_RNGR+$70
CLASS_ITEM4_10: equ CLASS_PHNK+$70
CLASS_ITEM4_11: equ CLASS_THIF+$70
CLASS_ITEM4_12: equ CLASS_TORT+$70
CLASS_ITEM4_13: equ CLASS_UNPRO13+$70
CLASS_ITEM4_14: equ CLASS_UNPRO14+$70
CLASS_ITEM4_15: equ CLASS_UNPRO15+$70
CLASS_ITEM4_16: equ CLASS_UNPRO16+$70

CLASS_BRGN: equ CLASS_SDMN+$80
CLASS_ITEM5_02: equ CLASS_KNTE+$80
CLASS_ITEM5_03: equ CLASS_WARR+$80
CLASS_ITEM5_04: equ CLASS_MAGE+$80
CLASS_ITEM5_05: equ CLASS_PRST+$80
CLASS_ITEM5_06: equ CLASS_ACHR+$80
CLASS_ITEM5_07: equ CLASS_BDMN+$80
CLASS_ITEM5_08: equ CLASS_WFMN+$80
CLASS_ITEM5_09: equ CLASS_RNGR+$80
CLASS_ITEM5_10: equ CLASS_PHNK+$80
CLASS_ITEM5_11: equ CLASS_THIF+$80
CLASS_ITEM5_12: equ CLASS_TORT+$80
CLASS_ITEM5_13: equ CLASS_UNPRO13+$80
CLASS_ITEM5_14: equ CLASS_UNPRO14+$80
CLASS_ITEM5_15: equ CLASS_UNPRO15+$80
CLASS_ITEM5_16: equ CLASS_UNPRO16+$80

CLASS_ITEM6_01: equ CLASS_SDMN+$90
CLASS_ITEM6_02: equ CLASS_KNTE+$90
CLASS_ITEM6_03: equ CLASS_WARR+$90
CLASS_ITEM6_04: equ CLASS_MAGE+$90
CLASS_ITEM6_05: equ CLASS_PRST+$90
CLASS_ITEM6_06: equ CLASS_ACHR+$90
CLASS_ITEM6_07: equ CLASS_BDMN+$90
CLASS_ITEM6_08: equ CLASS_WFMN+$90
CLASS_ITEM6_09: equ CLASS_RNGR+$90
CLASS_ITEM6_10: equ CLASS_PHNK+$90
CLASS_ITEM6_11: equ CLASS_THIF+$90
CLASS_ITEM6_12: equ CLASS_TORT+$90
CLASS_ITEM6_13: equ CLASS_UNPRO13+$90
CLASS_ITEM6_14: equ CLASS_UNPRO14+$90
CLASS_ITEM6_15: equ CLASS_UNPRO15+$90
CLASS_ITEM6_16: equ CLASS_UNPRO16+$90

CLASS_ITEM7_01: equ CLASS_SDMN+$A0
CLASS_ITEM7_02: equ CLASS_KNTE+$A0
CLASS_ITEM7_03: equ CLASS_WARR+$A0
CLASS_ITEM7_04: equ CLASS_MAGE+$A0
CLASS_ITEM7_05: equ CLASS_PRST+$A0
CLASS_ITEM7_06: equ CLASS_ACHR+$A0
CLASS_ITEM7_07: equ CLASS_BDMN+$A0
CLASS_ITEM7_08: equ CLASS_WFMN+$A0
CLASS_ITEM7_09: equ CLASS_RNGR+$A0
CLASS_ITEM7_10: equ CLASS_PHNK+$A0
CLASS_ITEM7_11: equ CLASS_THIF+$A0
CLASS_ITEM7_12: equ CLASS_TORT+$A0
CLASS_ITEM7_13: equ CLASS_UNPRO13+$A0
CLASS_ITEM7_14: equ CLASS_UNPRO14+$A0
CLASS_ITEM7_15: equ CLASS_UNPRO15+$A0
CLASS_ITEM7_16: equ CLASS_UNPRO16+$A0

CLASS_ITEM8_01: equ CLASS_SDMN+$B0
CLASS_ITEM8_02: equ CLASS_KNTE+$B0
CLASS_ITEM8_03: equ CLASS_WARR+$B0
CLASS_ITEM8_04: equ CLASS_MAGE+$B0
CLASS_ITEM8_05: equ CLASS_PRST+$B0
CLASS_ITEM8_06: equ CLASS_ACHR+$B0
CLASS_ITEM8_07: equ CLASS_BDMN+$B0
CLASS_ITEM8_08: equ CLASS_WFMN+$B0
CLASS_ITEM8_09: equ CLASS_RNGR+$B0
CLASS_ITEM8_10: equ CLASS_PHNK+$B0
CLASS_ITEM8_11: equ CLASS_THIF+$B0
CLASS_ITEM8_12: equ CLASS_TORT+$B0
CLASS_ITEM8_13: equ CLASS_UNPRO13+$B0
CLASS_ITEM8_14: equ CLASS_UNPRO14+$B0
CLASS_ITEM8_15: equ CLASS_UNPRO15+$B0
CLASS_ITEM8_16: equ CLASS_UNPRO16+$B0

CLASS_ITEM_01: equ CLASS_SDMN+$C0
CLASS_ITEM_02: equ CLASS_KNTE+$C0
CLASS_ITEM_03: equ CLASS_WARR+$C0
CLASS_ITEM_04: equ CLASS_MAGE+$C0
CLASS_ITEM_05: equ CLASS_PRST+$C0
CLASS_ITEM_06: equ CLASS_ACHR+$C0
CLASS_ITEM_07: equ CLASS_BDMN+$C0
CLASS_ITEM_08: equ CLASS_WFMN+$C0
CLASS_ITEM_09: equ CLASS_RNGR+$C0
CLASS_ITEM_10: equ CLASS_PHNK+$C0
CLASS_ITEM_11: equ CLASS_THIF+$C0
CLASS_ITEM_12: equ CLASS_TORT+$C0
CLASS_ITEM_13: equ CLASS_UNPRO13+$C0
CLASS_ITEM_14: equ CLASS_UNPRO14+$C0
CLASS_ITEM_15: equ CLASS_UNPRO15+$C0
CLASS_ITEM_16: equ CLASS_UNPRO16+$C0
CLASS_ITEM_17: equ CLASS_SDMN+$D0
CLASS_ITEM_18: equ CLASS_KNTE+$D0
CLASS_ITEM_19: equ CLASS_WARR+$D0
CLASS_ITEM_20: equ CLASS_MAGE+$D0
CLASS_ITEM_21: equ CLASS_PRST+$D0
CLASS_ITEM_22: equ CLASS_ACHR+$D0
CLASS_ITEM_23: equ CLASS_BDMN+$D0
CLASS_ITEM_24: equ CLASS_WFMN+$D0
CLASS_ITEM_25: equ CLASS_RNGR+$D0
CLASS_ITEM_26: equ CLASS_PHNK+$D0
CLASS_ITEM_27: equ CLASS_THIF+$D0
CLASS_ITEM_28: equ CLASS_TORT+$D0
CLASS_ITEM_29: equ CLASS_UNPRO13+$D0
CLASS_ITEM_30: equ CLASS_UNPRO14+$D0
CLASS_ITEM_31: equ CLASS_UNPRO15+$D0
CLASS_ITEM_32: equ CLASS_UNPRO16+$D0
...
CLASS_MASK_INDEX: equ $FF
CLASS_NUMBER_TOTAL: equ $E0
...
CLASSTYPE_ITEM1: equ $2
CLASSTYPE_ITEM2: equ $3
CLASSTYPE_ITEM3: equ $4
CLASSTYPE_ITEM4: equ $5
CLASSTYPE_ITEM5: equ $6
CLASSTYPE_ITEM6: equ $7
CLASSTYPE_ITEM7: equ $8
CLASSTYPE_ITEM8: equ $9
CLASSTYPE_AREA: equ $A

; ---------------------------------------------------------------------------

; enum Force
FORCE_MAX_SIZE: equ $C
FORCE_MAX_GOLD: equ $F423F
...
ENEMY_SPECIALS_START: equ $56

; ---------------------------------------------------------------------------

; enum EnemyDef
ENEMYDEF_OFFSET_SPELLPOWER: equ $A
ENEMYDEF_OFFSET_LEVEL: equ $B
ENEMYDEF_OFFSET_MOVETYPE: equ $41
ENEMYDEF_ENTRY_SIZE: equ $42
...
ITEMDEF_OFFSET_EQUIPFLAGS2: equ 4
ITEMDEF_OFFSET_EQUIPFLAGS3: equ 8
ITEMDEF_OFFSET_EQUIPFLAGS4: equ 12
ITEMDEF_OFFSET_EQUIPFLAGS5: equ 16
ITEMDEF_OFFSET_EQUIPFLAGS6: equ 20
ITEMDEF_OFFSET_EQUIPFLAGS7: equ 24
ITEMDEF_OFFSET_MAX_RANGE: equ 28
ITEMDEF_OFFSET_MIN_RANGE: equ 29
ITEMDEF_OFFSET_PRICE: equ 30
ITEMDEF_OFFSET_TYPE: equ 32
ITEMDEF_OFFSET_USE_SPELL: equ 33
ITEMDEF_OFFSET_EQUIPEFFECTS: equ 34
...
EQUIPFLAG2_HERO: equ $1
EQUIPFLAG2_PLDN: equ $2
EQUIPFLAG2_GLDT: equ $4
EQUIPFLAG2_WIZ: equ $8
EQUIPFLAG2_VICR: equ $10
EQUIPFLAG2_SNIP: equ $20
EQUIPFLAG2_BDBT: equ $40
EQUIPFLAG2_WFBR: equ $80
EQUIPFLAG2_BWNT: equ $100
EQUIPFLAG2_PHNX: equ $200
EQUIPFLAG2_NINJ: equ $400
EQUIPFLAG2_MNST: equ $800
EQUIPFLAG2_RBT: equ $1000
EQUIPFLAG2_GLM: equ $2000
EQUIPFLAG2_RDBN: equ $4000

EQUIPFLAG3_MMNK: equ $1
EQUIPFLAG3_PGNT: equ $10000
EQUIPFLAG4_BRN: equ $1
EQUIPFLAG4_SORC: equ $10000
EQUIPFLAG5_BRGN: equ $1
...
EQUIPFLAG3_NONE: equ $0
EQUIPFLAG3_ALL: equ $FFFFFFFF
EQUIPFLAG4_NONE: equ $0
EQUIPFLAG4_ALL: equ $FFFFFFFF
EQUIPFLAG5_NONE: equ $0
EQUIPFLAG5_ALL: equ $FFFFFFFF
EQUIPFLAG6_NONE: equ $0
EQUIPFLAG6_ALL: equ $FFFFFFFF
EQUIPFLAG7_NONE: equ $0
EQUIPFLAG7_ALL: equ $FFFFFFFF

; ---------------------------------------------------------------------------

; enum EquipEffects
EQUIPEFFECT_NONE: equ 0
EQUIPEFFECT_INCREASE_HP: equ 1
EQUIPEFFECT_INCREASE_MP: equ 2
EQUIPEFFECT_INCREASE_ATT: equ 3
EQUIPEFFECT_INCREASE_DEF: equ 4
EQUIPEFFECT_INCREASE_AGI: equ 5
EQUIPEFFECT_INCREASE_MOV: equ 6
EQUIPEFFECT_INCREASE_CRITICAL: equ 7
EQUIPEFFECT_INCREASE_DOUBLE: equ 8
EQUIPEFFECT_INCREASE_COUNTER: equ 9
EQUIPEFFECT_INCREASE_RES_WIND_ELEC_ICE_FIRE: equ 10
EQUIPEFFECT_INCREASE_RES_NEUTRAL_STATUS: equ 11
EQUIPEFFECT_DECREASE_HP: equ 12
EQUIPEFFECT_DECREASE_MP: equ 13
EQUIPEFFECT_DECREASE_ATT: equ 14
EQUIPEFFECT_DECREASE_DEF: equ 15
EQUIPEFFECT_DECREASE_AGI: equ 16
EQUIPEFFECT_DECREASE_MOV: equ 17
EQUIPEFFECT_DECREASE_CRITICAL: equ 18
EQUIPEFFECT_DECREASE_DOUBLE: equ 19
EQUIPEFFECT_DECREASE_COUNTER: equ 20
EQUIPEFFECT_DECREASE_RES_WIND_ELEC_ICE_FIRE: equ 21
EQUIPEFFECT_DECREASE_RES_NEUTRAL_STATUS: equ 22
EQUIPEFFECT_SET_HP: equ 23
EQUIPEFFECT_SET_MP: equ 24
EQUIPEFFECT_SET_ATT: equ 25
EQUIPEFFECT_SET_DEF: equ 26
EQUIPEFFECT_SET_AGI: equ 27
EQUIPEFFECT_SET_MOV: equ 28
EQUIPEFFECT_SET_CRITICAL: equ 29
EQUIPEFFECT_SET_DOUBLE: equ 30
EQUIPEFFECT_SET_COUNTER: equ 31
EQUIPEFFECT_SET_RES_WIND_ELEC_ICE_FIRE: equ 32
EQUIPEFFECT_SET_RES_NEUTRAL_STATUS: equ 33
...
EQUIPEFFECTS_COUNTER: equ 4
EQUIPEFFECTS_ENTRY_SIZE: equ 2
EQUIPEFFECTS_MAX_INDEX: equ 33
...
ITEM_ANGEL_WING: equ $0
ITEM_MEDICAL_HERB: equ $1
ITEM_HEALING_SEED: equ $2
ITEM_HEALING_DROP: equ $3
ITEM_MEDICAL_CANDY: equ $4
ITEM_HEALING_WATER: equ $5
ITEM_HEALING_RAIN: equ $6
ITEM_REFILL1: equ $7
ITEM_FAIRY_TEAR: equ $8
ITEM_REFILL3: equ $9
ITEM_REFILL4: equ $A
ITEM_RIGHT_OF_HOPE: equ $B
ITEM_ANTIDOTE: equ $C
ITEM_FAIRY_POWDER: equ $D
ITEM_CURE3: equ $E
ITEM_CURE4: equ $F
ITEM_BRAVE_APPLE: equ $10
ITEM_CHEERFUL_BREAD: equ $11
ITEM_BRIGHT_HONEY: equ $12
ITEM_POWER_WATER: equ $13
ITEM_PROTECT_MILK: equ $14
ITEM_QUICK_CHICKEN: equ $15
ITEM_RUNNING_PIMENTO: equ $16
ITEM_SHINING_BALL: equ $17
ITEM_BLIZZARD: equ $18
ITEM_HOLY_THUNDER: equ $19

ITEM_POWER_RING: equ $20
ITEM_PROTECT_RING: equ $21
ITEM_QUICK_RING: equ $22
ITEM_RUNNING_RING: equ $23
ITEM_WHITE_RING: equ $24
ITEM_BLACK_RING: equ $25
ITEM_EVIL_RING: equ $26
ITEM_CHIRRUP_SANDALS: equ $27
ITEM_LIFE_RING: equ $28

ITEM_LEATHER_GLOVE: equ $30
ITEM_POWER_GLOVE: equ $31
ITEM_BRASS_KNUCKLES: equ $32
ITEM_IRON_KNUCKLES: equ $33
ITEM_MISTY_KNUCKLES: equ $34
ITEM_GIANT_KNUCKLES: equ $35
ITEM_EVIL_KNUCKLES: equ $36
ITEM_SHORT_AXE: equ $37
ITEM_HAND_AXE: equ $38
ITEM_MIDDLE_AXE: equ $39
ITEM_POWER_AXE: equ $3A
ITEM_BATTLE_AXE: equ $3B
ITEM_LARGE_AXE: equ $3C
ITEM_GREAT_AXE: equ $3D
ITEM_HEAT_AXE: equ $3E
ITEM_ATLAS_AXE: equ $3F
ITEM_GROUND_AXE: equ $40
ITEM_RUNE_AXE: equ $41
ITEM_EVIL_AXE: equ $42
ITEM_WOODEN_ARROW: equ $43
ITEM_IRON_ARROW: equ $44
ITEM_STEEL_ARROW: equ $45
ITEM_ROBIN_ARROW: equ $46
ITEM_ASSAULT_SHELL: equ $47
ITEM_GREAT_SHOT: equ $48
ITEM_NAZCA_CANNON: equ $49
ITEM_BUSTER_SHOT: equ $4A
ITEM_HYPER_CANNON: equ $4B
ITEM_GRAND_CANNON: equ $4C
ITEM_EVIL_SHOT: equ $4D
ITEM_WOODEN_SWORD: equ $4E
ITEM_SHORT_SWORD: equ $4F
ITEM_MIDDLE_SWORD: equ $50
ITEM_LONG_SWORD: equ $51
ITEM_STEEL_SWORD: equ $52
ITEM_ACHILLES_SWORD: equ $53
ITEM_BROAD_SWORD: equ $54
ITEM_BUSTER_SWORD: equ $55
ITEM_GREAT_SWORD: equ $56
ITEM_CRITICAL_SWORD: equ $57
ITEM_BATTLE_SWORD: equ $58
ITEM_FORCE_SWORD: equ $59
ITEM_COUNTER_SWORD: equ $5A
ITEM_LEVANTER: equ $5B
ITEM_DARK_SWORD: equ $5C
ITEM_WOODEN_STICK: equ $5D
ITEM_SHORT_SPEAR: equ $5E
ITEM_BRONZE_LANCE: equ $5F
ITEM_SPEAR: equ $60
ITEM_STEEL_LANCE: equ $61
ITEM_POWER_SPEAR: equ $62
ITEM_HEAVY_LANCE: equ $63
ITEM_JAVELIN: equ $64
ITEM_CHROME_LANCE: equ $65
ITEM_VALKYRIE: equ $66
ITEM_HOLY_LANCE: equ $67
ITEM_MIST_JAVELIN: equ $68
ITEM_HALBERD: equ $69
ITEM_EVIL_LANCE: equ $6A
ITEM_WOODEN_ROD: equ $6B
ITEM_SHORT_ROD: equ $6C
ITEM_BRONZE_ROD: equ $6D
ITEM_IRON_ROD: equ $6E
ITEM_POWER_STICK: equ $6F
ITEM_FLAIL: equ $70
ITEM_GUARDIAN_STAFF: equ $71
ITEM_INDRA_STAFF: equ $72
ITEM_MAGE_STAFF: equ $73
ITEM_WISH_STAFF: equ $74
ITEM_GREAT_ROD: equ $75
ITEM_SUPPLY_STAFF: equ $76
ITEM_HOLY_STAFF: equ $77
ITEM_FREEZE_STAFF: equ $78
ITEM_GODDESS_STAFF: equ $79
ITEM_MYSTERY_STAFF: equ $7A
ITEM_DEMON_ROD: equ $7B
ITEM_IRON_BALL: equ $7C
ITEM_SHORT_KNIFE: equ $7D
ITEM_DAGGER: equ $7E
ITEM_KNIFE: equ $7F
ITEM_THIEVES_DAGGER: equ $80
ITEM_KATANA: equ $81
ITEM_NINJA_KATANA: equ $82
ITEM_GISARME: equ $83
ITEM_TAROS_SWORD: equ $84

ITEM_WOODEN_PANEL: equ $E0
ITEM_SKY_ORB: equ $E1
ITEM_CANNON: equ $E2
ITEM_DRY_STONE: equ $E3
ITEM_DYNAMITE: equ $E4
ITEM_ARM_OF_GOLEM: equ $E5
ITEM_COTTON_BALLOON: equ $E6
ITEM_MITHRIL: equ $E7

ITEM_VIGOR_BALL: equ $F7
ITEM_PEGASUS_WING: equ $F8
ITEM_WARRIORS_PRIDE: equ $F9
ITEM_SECRET_BOOK: equ $FA
ITEM_SILVER_TANK: equ $FB
ITEM_PROMOITEM6: equ $FC
ITEM_PROMOITEM7: equ $FD
ITEM_PROMOITEM8: equ $FE
ITEM_NOTHING: equ $FF
...
ITEMINDEX_WEAPONS_START: equ $30
ITEMINDEX_WEAPONS_END: equ $DF
...
BREAKTYPE_FLAMES: equ $0
BREAKTYPE_PIECES: equ $1
BREAKTYPE_SPLIT: equ $2
BREAKTYPE_MANGLE: equ $3
BREAKTYPE_RUST: equ $4
...
ENTITYDEF_OFFSET_YVELOCITY: equ $5
ENTITYDEF_OFFSET_MAPSPRITE: equ $6
ENTITYDEF_OFFSET_XTRAVEL: equ $8
ENTITYDEF_OFFSET_XTRAVEL_LOWERBYTE: equ $9
ENTITYDEF_OFFSET_YTRAVEL: equ $A
ENTITYDEF_OFFSET_YTRAVEL_LOWERBYTE: equ $B
ENTITYDEF_OFFSET_XDEST: equ $C
ENTITYDEF_OFFSET_XDEST_LOWERBYTE: equ $D
...
ENTITYDEF_SECOND_ENTITY_XDEST: equ ENTITYDEF_SIZE+ENTITYDEF_OFFSET_XDEST
ENTITYDEF_SECOND_ENTITY_YDEST: equ ENTITYDEF_SIZE+ENTITYDEF_OFFSET_YDEST
ENTITYDEF_SECOND_ENTITY_MAPSPRITE: equ ENTITYDEF_SIZE+ENTITYDEF_OFFSET_MAPSPRITE
ENTITYDEF_ENTITY32_XDEST: equ 31*ENTITYDEF_SIZE+ENTITYDEF_OFFSET_XDEST
ENTITYDEF_ENTITY32_YDEST: equ 31*ENTITYDEF_SIZE+ENTITYDEF_OFFSET_YDEST
...
ENTITY_CURSOR_WORD_ADDRESS: equ ENTITY_CURSOR_DATA-FF0000_RAM_START
ENTITY_LAST_SPRITE_PLUS_ONE_WORD_ADDRESS: equ SPRITE_63+VDP_SPRITE_SIZE-FF0000_RAM_START

; ---------------------------------------------------------------------------

; enum cutsceneCommand_Offsets

;followEntity
FOLLOWING_ENTITY: equ 2
ENTITY_TO_FOLLOW: equ 4
FOLLOW_POSITION: equ 6
...
SPELLENTRY_SPELLS_NUMBER: equ $3F
...
CHANCE_TO_DODGE_FOR_MUDDLED_ATTACKER: equ 128
...
CHANCE_TO_DODGE_FOR_AIRBORNE_TARGET: equ 32
CHANCE_TO_DODGE_DEFAULT: equ 8
...
MAP_OVERWORLD_GRANS_GRANSEAL: equ $50
MAP_OVERWORLD_DEVILS_TAIL: equ $51
MAP_OVERWORLD_AROUND_ELVEN_VILLAGE: equ $52
MAP_OVERWORLD_PATH_TO_RIBBLE: equ $53
MAP_OVERWORLD_SOUTHEAST_PARMECIA: equ $54
MAP_OVERWORLD_AROUND_PACALON: equ $55
MAP_OVERWORLD_NORTH_SOUTH_PARMECIA_JUNCTION: equ $56
MAP_OVERWORLD_NEW_GRANSEAL_SHORE: equ $57
MAP_OVERWORLD_MOUN_AND_MITULA: equ $58
MAP_OVERWORLD_GRANS_NORTH_SHORE: equ $59
MAP_OVERWORLD_GRANS_RETURN_PATH: equ $5A
MAP_OVERWORLD_GRANS_AROUND_DWARF_VILLAGE: equ $5B
MAP_OVERWORLD_PACALON_2: equ $5C
MAP_CURRENT: equ $FF
...
BATTLEACTION_BURST_ROCK_POWER: equ $19
...
BATTLESCENE_STACK_NEGSIZE: equ -156
...
WINDOW_BATTLEEQUIP_SIZE: equ $A0D
...
WINDOW_MINISTATUS_SIDECOLUMNS_NUMBER_PLUS_ONE: equ 10
WINDOW_MINISTATUS_MIN_WIDTH: equ 12
WINDOW_MINISTATUS_OFFSET_STAT_VALUES: equ 16
WINDOW_MINISTATUS_MAX_WIDTH: equ 24
WINDOW_MINISTATUS_OFFSET_NEXT_LINE: equ 48
WINDOW_MINISTATUS_LONGWORD_COUNTER: equ 59
WINDOW_MINISTATUS_OFFSET_NEXT_TWO_LINES: equ 96
...
WINDOW_LANDEFFECT_TEXT_HEADER_OFFSET: equ 14
WINDOW_LANDEFFECT_TEXT_VALUE_OFFSET: equ 40
...
WINDOW_MEMBERSTATUS_OFFSET_ENEMY_LV: equ 142
WINDOW_MEMBERSTATUS_OFFSET_LV: equ 144
WINDOW_MEMBERSTATUS_OFFSET_ATT: equ $A0
WINDOW_MEMBERSTATUS_OFFSET_CURRENT_HP: equ 218
WINDOW_MEMBERSTATUS_OFFSET_MAX_HP: equ $E2
WINDOW_MEMBERSTATUS_OFFSET_DEF: equ $F4
WINDOW_MEMBERSTATUS_OFFSET_CURRENT_MP: equ 302
WINDOW_MEMBERSTATUS_OFFSET_MAX_MP: equ $136
WINDOW_MEMBERSTATUS_OFFSET_AGI: equ $148
WINDOW_MEMBERSTATUS_OFFSET_ENEMY_EXP: equ 394
WINDOW_MEMBERSTATUS_OFFSET_EXP: equ 396
...
WINDOW_MEMBERS_LIST_PAGE_HPMP: equ 255
WINDOW_MEMBERS_LIST_HIGHLIGHTSPRITES_COUNTER: equ $2
WINDOW_MEMBERS_LIST_PAGE_STATS: equ $1
WINDOW_MEMBERS_LIST_PAGE_STATS2: equ $2
WINDOW_MEMBERS_LIST_PAGE_NEWATTANDDEF: equ $3
WINDOW_MEMBERLIST_PAGE_NEWHPANDMP: equ $4
WINDOW_MEMBERLIST_PAGE_NEWAGIANDMOVE: equ $5
WINDOW_MEMBERS_LIST_OFFSET_ENTRY_NEWDEFENSE: equ $4
...
WINDOW_MEMBERS_LIST_SPRITELINK_DOWNARROW: equ 12
WINDOW_MEMBERS_LIST_ENTRY_UNEQUIPPABLE_LENGTH: equ $10
WINDOW_MEMBERS_LIST_OFFSET_ENTRY_START: equ 16
WINDOW_MEMBERS_LIST_SPRITELINK_UPARROW: equ $10
WINDOW_MEMBERS_LIST_OFFSET_ENTRY_LEVEL: equ 22
...
WINDOW_MEMBERSUMMARY_OFFSET_SPELL_LEVEL: equ 16
...
WINDOW_MEMBERSUMMARY_MEMBERPAGE_OFFSET_MAGICLIST_START: equ 170
...
WINDOW_MEMBERSUMMARY_MAGICPAGE_OFFSET_MAGICLIST_START: equ 190
...
WINDOW_NAMEALLY_OFFSET_ENTRY: equ 24
...
WINDOW_NAMEALLY_ENTRY_SIZE: equ $B03
...
WINDOW_TACTICAL_BASE_NAME_SIZE: equ $B03
...
ALLYBATTLEANIMATION_SPECIALS_START: equ $28
ALLYBATTLEANIMATION_SPECIAL_SPEARTHROW_KNTE: equ $28
ALLYBATTLEANIMATION_SPECIAL_SPEARTHROW_PLDN: equ $29
ALLYBATTLEANIMATION_SPECIAL_SPEARTHROW_PGNT: equ $2A
ALLYBATTLEANIMATION_SPECIAL_MMNK: equ $2B
ALLYBATTLEANIMATION_SPECIAL_MNST: equ $2C
ALLYBATTLEANIMATION_SPECIAL_RBT: equ $2D
ALLYBATTLEANIMATION_SPECIAL_BRGN: equ $2E
...
MAPSPRITE_SARAH_BASE: equ $1
MAPSPRITE_CHESTER_BASE: equ $2
MAPSPRITE_JAHA_BASE: equ $3
MAPSPRITE_KAZIN_BASE: equ $4
MAPSPRITE_SLADE_BASE: equ $5
MAPSPRITE_KIWI_BASE: equ $6
MAPSPRITE_PETER_BASE: equ $7
MAPSPRITE_MAY_BASE: equ $8
MAPSPRITE_GERHALT_BASE: equ $9
MAPSPRITE_LUKE_BASE: equ $A
MAPSPRITE_RICK_BASE: equ $B
MAPSPRITE_ELRIC_BASE: equ $C
MAPSPRITE_ERIC_BASE: equ $D
MAPSPRITE_KARNA_BASE: equ $E
MAPSPRITE_RANDOLF_BASE: equ $F
MAPSPRITE_TYRIN_BASE: equ $10
MAPSPRITE_JANET_BASE: equ $11
MAPSPRITE_ROHDE_BASE: equ $12
MAPSPRITE_HIGINS_BASE: equ $13
MAPSPRITE_TAYA_BASE: equ $14
MAPSPRITE_SKREECH_BASE: equ $15
MAPSPRITE_FRAYJA_BASE: equ $16
MAPSPRITE_JARO_BASE: equ $17
MAPSPRITE_GYAN_BASE: equ $18
MAPSPRITE_SHEELA_BASE: equ $19
MAPSPRITE_ZYNK_BASE: equ $1A
MAPSPRITE_CHAZ_BASE: equ $1B
MAPSPRITE_LEMON_BASE: equ $1C
MAPSPRITE_CLAUDE_BASE: equ $1D
MAPSPRITE_JOGURT: equ $1E

MAPSPRITE_BOWIE_PROMO: equ $1F
MAPSPRITE_SARAH_PROMO: equ $20
MAPSPRITE_CHESTER_PROMO: equ $21
MAPSPRITE_JAHA_PROMO: equ $22
MAPSPRITE_KAZIN_PROMO: equ $23
MAPSPRITE_SLADE_PROMO: equ $24
MAPSPRITE_KIWI_PROMO: equ $25
MAPSPRITE_PETER_PROMO: equ $26
MAPSPRITE_MAY_PROMO: equ $27
MAPSPRITE_GERHALT_PROMO: equ $28
MAPSPRITE_LUKE_PROMO: equ $29
MAPSPRITE_RICK_PROMO: equ $2A
MAPSPRITE_ELRIC_PROMO: equ $2B
MAPSPRITE_ERIC_PROMO: equ $2C
MAPSPRITE_KARNA_PROMO: equ $2D
MAPSPRITE_RANDOLF_PROMO: equ $2E
MAPSPRITE_TYRIN_PROMO: equ $2F
MAPSPRITE_JANET_PROMO: equ $30
MAPSPRITE_HIGINS_PROMO: equ $31
MAPSPRITE_SKREECH_PROMO: equ $32
MAPSPRITE_FRAYJA_PROMO: equ $33
MAPSPRITE_GYAN_PROMO: equ $34
MAPSPRITE_ZYNK_PROMO: equ $35
MAPSPRITE_CHAZ_PROMO: equ $36
MAPSPRITE_CLAUDE_PROMO: equ $37

MAPSPRITE_SARAH_SPECIAL: equ $38
MAPSPRITE_CHESTER_SPECIAL: equ $39
MAPSPRITE_JAHA_SPECIAL: equ $3A
MAPSPRITE_KAZIN_SPECIAL: equ $3B
MAPSPRITE_ROHDE_SPECIAL: equ $3C
MAPSPRITE_RICK_SPECIAL: equ $3D
MAPSPRITE_ELRIC_SPECIAL: equ $3E
MAPSPRITE_ERIC_SPECIAL: equ $3F
MAPSPRITE_KARNA_SPECIAL: equ $40
MAPSPRITE_RANDOLF_SPECIAL: equ $41
MAPSPRITE_TYRIN_SPECIAL: equ $42
MAPSPRITE_JANET_SPECIAL: equ $43
MAPSPRITE_TAYA_SPECIAL: equ $44
MAPSPRITE_JARO_SPECIAL: equ $45
MAPSPRITE_SHEELA_SPECIAL: equ $46
MAPSPRITE_LEMON_SPECIAL: equ $47

MAPSPRITE_POSE1: equ $48
MAPSPRITE_BLANK: equ $49
MAPSPRITE_RAFT: equ $4A
MAPSPRITE_CARAVAN: equ $4B
MAPSPRITE_EFFECT1: equ $4C

MAPSPRITE_OOZE: equ $1F4
MAPSPRITE_HUGE_RAT: equ $1F5
MAPSPRITE_GALAM_SOLDIER: equ $1F6
MAPSPRITE_GALAM_KNIGHT: equ $1F7
MAPSPRITE_GOBLIN: equ $1F8
MAPSPRITE_GREEN_OOZE: equ $1F9
MAPSPRITE_DARK_DWARF: equ $1FA
MAPSPRITE_HOBGOBLIN: equ $1FB
MAPSPRITE_ZOMBIE: equ $1FC
MAPSPRITE_GOLEM: equ $1FD
MAPSPRITE_KRAKEN_LEG: equ $1FE
MAPSPRITE_SOULSOWER: equ $1FF
MAPSPRITE_ORC: equ $200
MAPSPRITE_PAWN: equ $201
MAPSPRITE_KNIGHT: equ $202
MAPSPRITE_RAT: equ $203
MAPSPRITE_BUBBLING_OOZE: equ $204
MAPSPRITE_SKELETON: equ $205
MAPSPRITE_DARK_SOLDIER: equ $206
MAPSPRITE_LIZARDMAN: equ $207
MAPSPRITE_WORM: equ $208
MAPSPRITE_DARK_KNIGHT: equ $209
MAPSPRITE_ORC_LORD: equ $20A
MAPSPRITE_DEVIL_SOLDIER: equ $20B
MAPSPRITE_CERBERUS: equ $20C
MAPSPRITE_MUD_MAN: equ $20D
MAPSPRITE_DRAGONEWT: equ $20E
MAPSPRITE_PURPLE_WORM: equ $20F
MAPSPRITE_EXECUTIONER: equ $210
MAPSPRITE_HELL_HOUND: equ $211
MAPSPRITE_MINOTAUR: equ $212
MAPSPRITE_CYCLOPS: equ $213
MAPSPRITE_BURST_ROCK: equ $214
MAPSPRITE_HYDRA: equ $215
MAPSPRITE_CHAOS_WARRIOR: equ $216
MAPSPRITE_REAPER: equ $217
MAPSPRITE_EVIL_BEAST: equ $218
MAPSPRITE_PYROHYDRA: equ $219
MAPSPRITE_ZEON_GUARD: equ $21A
MAPSPRITE_GIZMO: equ $21B
MAPSPRITE_HUGE_BAT: equ $21C
MAPSPRITE_VAMPIRE_BAT: equ $21D
MAPSPRITE_EVIL_CLOUD: equ $21E
MAPSPRITE_GARGOYLE: equ $21F
MAPSPRITE_HARPY: equ $220
MAPSPRITE_LESSER_DEMON: equ $221
MAPSPRITE_WYVERN: equ $222
MAPSPRITE_HARPY_QUEEN: equ $223
MAPSPRITE_PEGASUS_KNIGHT: equ $224
MAPSPRITE_GRIFFIN: equ $225
MAPSPRITE_MIST_DEMON: equ $226
MAPSPRITE_WHITE_DRAGON: equ $227
MAPSPRITE_DEMON: equ $228
MAPSPRITE_CHAOS_DRAGON: equ $229
MAPSPRITE_DEVIL_GRIFFIN: equ $22A
MAPSPRITE_ARCH_DEMON: equ $22B
MAPSPRITE_GALAM_ARCHER: equ $22C
MAPSPRITE_HUNTER_GOBLIN: equ $22D
MAPSPRITE_DEATH_ARCHER: equ $22E
MAPSPRITE_KRAKEN_ARM: equ $22F
MAPSPRITE_ARROW_LAUNCHER: equ $230
MAPSPRITE_ROOK: equ $231
MAPSPRITE_DARK_SNIPER: equ $232
MAPSPRITE_BOW_MASTER: equ $233
MAPSPRITE_BOW_RIDER: equ $234
MAPSPRITE_DARK_GUNNER: equ $235
MAPSPRITE_HORSEMAN: equ $236
MAPSPRITE_GALAM_MAGE: equ $237
MAPSPRITE_WITCH: equ $238
MAPSPRITE_MASTER_MAGE: equ $239
MAPSPRITE_DARK_MADAM: equ $23A
MAPSPRITE_QUEEN: equ $23B
MAPSPRITE_WIZARD: equ $23C
MAPSPRITE_NECROMANCER: equ $23D
MAPSPRITE_CHAOS_WIZARD: equ $23E
MAPSPRITE_DEMON_MASTER: equ $23F
MAPSPRITE_DARK_CLERIC: equ $240
MAPSPRITE_DEATH_MONK: equ $241
MAPSPRITE_BLACK_MONK: equ $242
MAPSPRITE_HIGH_PRIEST: equ $243
MAPSPRITE_BISHOP: equ $244
MAPSPRITE_DARK_BISHOP: equ $245
MAPSPRITE_MASTER_MONK: equ $246
MAPSPRITE_SHAMAN: equ $247
MAPSPRITE_EVIL_BISHOP: equ $248
MAPSPRITE_BLUE_SHAMAN: equ $249
MAPSPRITE_DARK_SMOKE: equ $24A
MAPSPRITE_KING: equ $24B
MAPSPRITE_WILLARD: equ $24C
MAPSPRITE_ZALBARD: equ $24D
MAPSPRITE_CAMEELA: equ $24E
MAPSPRITE_PRISM_FLOWER: equ $24F
MAPSPRITE_RED_BARON: equ $250
MAPSPRITE_GESHP: equ $251
MAPSPRITE_ODD_EYE: equ $252
MAPSPRITE_GALAM_ZEON: equ $253
MAPSPRITE_GALAM_EVIL: equ $254

MAPSPRITE_NPC_ROHDE: equ $2F4
MAPSPRITE_FLAME1: equ $2F5
MAPSPRITE_ORB: equ $2F6
MAPSPRITE_OBJECT1: equ $2F7
MAPSPRITE_POSE2: equ $2F8
MAPSPRITE_EFFECT2: equ $2F9
MAPSPRITE_POSE3: equ $2FA
MAPSPRITE_POSE4: equ $2FB
MAPSPRITE_EFFECT3: equ $2FC
MAPSPRITE_OBJECT2: equ $2FD
MAPSPRITE_OBJECT3: equ $2FE
MAPSPRITE_OBJECT4: equ $2FF
MAPSPRITE_CHICK_FLYING: equ $300
MAPSPRITE_EFFECT4: equ $301
MAPSPRITE_POSE5: equ $302
MAPSPRITE_ZELOT: equ $303
MAPSPRITE_EFFECT5: equ $304
MAPSPRITE_EFFECT6: equ $305
MAPSPRITE_DESKTOP_KING: equ $306
MAPSPRITE_HAWEL: equ $307
MAPSPRITE_BLUE_FLAME: equ $308
MAPSPRITE_PRIEST: equ $30A
MAPSPRITE_SAILOR: equ $30B
MAPSPRITE_MAN1: equ $30C
MAPSPRITE_WOMAN1: equ $30D
MAPSPRITE_MAN2: equ $30E
MAPSPRITE_WOMAN2: equ $30F
MAPSPRITE_MAN3: equ $310
MAPSPRITE_WOMAN3: equ $311
MAPSPRITE_BOY: equ $312
MAPSPRITE_GIRL: equ $313
MAPSPRITE_WORKER: equ $314
MAPSPRITE_GRANSEAL_KING: equ $315
MAPSPRITE_ELIS: equ $316
MAPSPRITE_MINISTER: equ $317
MAPSPRITE_SOLDIER1: equ $318
MAPSPRITE_SOLDIER2: equ $319
MAPSPRITE_MAID: equ $31A
MAPSPRITE_ASTRAL: equ $31B
MAPSPRITE_CAT: equ $31C
MAPSPRITE_BOAT: equ $31D
MAPSPRITE_CREED: equ $31E
MAPSPRITE_ODDLER: equ $31F
MAPSPRITE_GALAM_KING: equ $320
MAPSPRITE_MITULA: equ $321
MAPSPRITE_POSE6: equ $322
MAPSPRITE_POSE7: equ $323
MAPSPRITE_DUCK: equ $324
MAPSPRITE_FAIRY: equ $325
MAPSPRITE_BEASTMAN1: equ $326
MAPSPRITE_TURTLE: equ $327
MAPSPRITE_BEASTMAN2: equ $328
MAPSPRITE_ELF_BOY: equ $329
MAPSPRITE_ELF_GIRL: equ $32A
MAPSPRITE_VIKING: equ $32B
MAPSPRITE_DWARF: equ $32C
MAPSPRITE_BEDOE_KING: equ $32D
MAPSPRITE_BEDOE_MINISTER: equ $32E
MAPSPRITE_BEDOE_SOLDIER: equ $32F
MAPSPRITE_CHICK: equ $330
MAPSPRITE_PACALON_KING: equ $331
MAPSPRITE_PACALON_PRINCESS: equ $332
MAPSPRITE_PACALON_SOLDIER: equ $333
MAPSPRITE_PACALON_MAID: equ $334
MAPSPRITE_HEN: equ $335
MAPSPRITE_BIRDMAN: equ $336

MAPSPRITE_END_LIST: equ $3E8

MAPSPRITE_ZEON: equ $3FB
MAPSPRITE_EVIL_SPIRIT: equ $3FC
MAPSPRITE_NAZCA_SHIP: equ $3FD
MAPSPRITE_KRAKEN: equ $3FE
MAPSPRITE_TAROS: equ $3FF
...
PORTRAIT_BOWIE_PROMO: equ $1
PORTRAIT_SARAH: equ $2
PORTRAIT_CHESTER: equ $4
PORTRAIT_JAHA: equ $6
PORTRAIT_KAZIN: equ $8
PORTRAIT_SLADE_BASE: equ $A
PORTRAIT_SLADE_PROMO: equ $B
PORTRAIT_KIWI_BASE: equ $C
PORTRAIT_KIWI_PROMO: equ $D
PORTRAIT_PETER_BASE: equ $E
PORTRAIT_PETER_PROMO: equ $F
PORTRAIT_MAY: equ $10
PORTRAIT_GERHALT_BASE: equ $12
PORTRAIT_GERHALT_PROMO: equ $13
PORTRAIT_LUKE: equ $14
PORTRAIT_ROHDE: equ $17
PORTRAIT_RICK: equ $18
PORTRAIT_ELRIC: equ $1A
PORTRAIT_ERIC: equ $1C
PORTRAIT_KARNA: equ $1E
PORTRAIT_RANDOLF: equ $20
PORTRAIT_TYRIN: equ $22
PORTRAIT_JANET: equ $24
PORTRAIT_HIGINS: equ $27
PORTRAIT_SKREECH: equ $29
PORTRAIT_TAYA: equ $2B
PORTRAIT_FRAYJA: equ $2D
PORTRAIT_JARO: equ $2F
PORTRAIT_GYAN: equ $31
PORTRAIT_SHEELA: equ $33
PORTRAIT_ZYNK: equ $35
PORTRAIT_CHAZ: equ $37
PORTRAIT_LEMON: equ $39
PORTRAIT_CLAUDE: equ $3B
PORTRAIT_JOGURT: equ $3D

PORTRAIT_ELIS: equ $3E
PORTRAIT_ASTRAL: equ $3F
PORTRAIT_GRANSEAL_KING: equ $40
PORTRAIT_SAILOR: equ $41
PORTRAIT_PRIEST: equ $42
PORTRAIT_MITULA: equ $43
PORTRAIT_CREED: equ $44
PORTRAIT_GALAM_KING: equ $45
PORTRAIT_GALAM_EVIL: equ $46
PORTRAIT_ODDLER: equ $47
PORTRAIT_ODD_EYE: equ $48
PORTRAIT_TAROS: equ $49
PORTRAIT_ZALBARD: equ $4A
PORTRAIT_CAMEELA: equ $4B
PORTRAIT_GESHP: equ $4C
PORTRAIT_ZEON: equ $4D
PORTRAIT_BOWIE_PAINTING: equ $4E
...
MAPSPRITEDIALOGUEDEF_OFFSET_PORTRAIT: equ 2
MAPSPRITEDIALOGUEDEF_OFFSET_SPEECHSFX: equ 3
...
GROWTHCURVE_DEF_SIZE: equ $C4

; ---------------------------------------------------------------------------

; enum AllyName

ALLYNAME_MAX_DISPLAYED_LENGTH: equ 9
...
HARD_TO_SUPER_ATT: equ 4
HARD_TO_SUPER_DEF: equ 5
HARD_TO_SUPER_AGI: equ 4
SUPER_TO_OUCH_ATT: equ 5
...
SAVE_BLOCK_COUNTER: equ $1FF
COMBATANT_BLOCK_COUNTER: equ $11FF
SAVE_SLOT_COUNTER: equ $13FF
SAVE_SLOT_SIZE: equ $1400
...
CONFIG_TURBO: equ 0
CONFIG_CONTROL_OPPONENT: equ 1
CONFIG_AUTOBATTLE: equ 2
CONFIG_1: equ 3
CONFIG_2: equ 4
CONFIG_3: equ 5
CONFIG_4: equ 6
