...
; ASM FILE data\battles\entries\battle06\cs_afterbattle.asm :
; 0x4F47A..0x4F48A : Cutscene after battle 0
bbcs_06:        textCursor STORYTEXT_OFFSET_PACKAGE_FOR_GALAM
                ...
                setF FLAG_BATTLE07_AVAILABLE          ; Battle 7 unlocked - BATTLE_VERSUS_DARK_SMOKES        
                csc_end
ce_49CBA:       mainEntity 30,9,DOWN
                ...
                cscEntitiesEnd
bscs_battle06:  csc_end
rbcs_battle06:  csc_end
edcs_battle06:  csc_end
abcs_battle06:  csc_end
