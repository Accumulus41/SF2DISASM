...
Map30_EntityEvent1:
                ...
                setFlg  FLAG_DWARVENMINE1             ; Set after talking to one of the dwarves in the mine near the Fairy Woods
                rts
...
loc_5A296:
                ...
                jsr     (Sleep).w       
                clsTxt
                setFlg  FLAG_DWARVENMINE3             ; Set after the dwarf gives Bowie the cannon
