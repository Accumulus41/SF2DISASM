...
Map19_EntityEvent12:
                ...
                chkFlg  FLAG_CASTLEGRANS2             ; Set after talking to Astral about going to the tower
                bne.s   byte_52F04
                script  cs_52F0C
                setFlg  FLAG_CASTLEGRANS2             ; Set after talking to Astral about going to the tower
...
cs_52F0C:       textCursor 575
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_52F40 ; YES/NO prompt answer
...
cs_52F40:       textCursor 578
                ...
                setF FLAG_CASTLEGRANS3                ; Set after agreeing to go to the tower with Astral
                csc_end
