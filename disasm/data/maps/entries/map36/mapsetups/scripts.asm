...
cs_5DA28:       textCursor 3323
                ...
                setF FLAG_BATTLE31_AVAILABLE         ; Battle 31 unlocked - BATTLE_PACALON                   
                setF FLAG_BATTLE33_AVAILABLE         ; Battle 33 unlocked - BATTLE_INSIDE_MOUN               
                setF FLAG_BATTLE34_AVAILABLE         ; Battle 34 unlocked - BATTLE_VERSUS_CAMEELA            
                csc_end
