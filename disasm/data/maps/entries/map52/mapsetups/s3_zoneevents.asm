...
Map52_ZoneEvent0:
                ...
                chkFlg  FLAG_VOLCANO2             ; Set after the scene at the cliffs before Bedoe, where the devils are searching
                bne.s   Map52_DefaultZoneEvent
                lea     cs_5C4EE(pc), a0
                jsr     ExecuteMapScript
                setFlg  FLAG_VOLCANO2             ; Set after the scene at the cliffs before Bedoe, where the devils are searching
