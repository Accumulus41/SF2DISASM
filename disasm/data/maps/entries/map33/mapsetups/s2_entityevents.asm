...
byte_5A800:
                ...
                chkFlg  FLAG_DWARVENMINE1             ; Set after talking to one of the dwarves in the mine near the Fairy Woods
                bne.s   byte_5A80C      
...
byte_5A814:
                ...
                clsTxt
                script  cs_5A828
                setFlg  FLAG_CREEDSMANSION1             ; Set after the fairy tags along at Creed's
                setFlg  FLAG_CREEDSMANSION4             ; Set after the fairy tags along at Creed's
return_5A826:
...
Map33_EntityEvent3:
                ...
                chkFlg  FLAG_GARDENMITULA1              ; Frayja joined
                bne.s   byte_5A85C
                chkFlg  FLAG_CREEDSMANSION6             ; Set after one of Creed's Mansion Force Members joins
                bne.s   byte_5A856      
                script  cs_5A8CA
                dc.w $6004
byte_5A856:
...
cs_5A8CA:       textCursor 1907
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5A8E6 ; YES/NO prompt answer
                nextSingleText $0,ALLY_ERIC ; "What a pity...then, I wish{N}happiness to all of you.{W1}"
                csc_end
cs_5A8E6:       join ALLY_ERIC
                setF FLAG_CREEDSMANSION6                ; Set after one of Creed's Mansion Force Members joins
...
cs_5A90E:       textCursor 1920
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5A92A ; YES/NO prompt answer
...
cs_5A93A:       textCursor 1910
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5A956 ; YES/NO prompt answer
...
cs_5A97E:       textCursor 1923
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5A99A ; YES/NO prompt answer
...
cs_5A9AA:       textCursor 1913
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5A9C6 ; YES/NO prompt answer
...
cs_5A9EE:       textCursor 1926
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5AA0A ; YES/NO prompt answer
...
cs_5AA1A:       textCursor 1916
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5AA36 ; YES/NO prompt answer
...
cs_5AA5E:       textCursor 1929
                ...
                yesNo
                jumpIfFlagSet FLAG_YESNO,cs_5AA7A ; YES/NO prompt answer
