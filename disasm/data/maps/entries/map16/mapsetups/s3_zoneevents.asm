...
Map16_ZoneEvent0:
                ...
                bne.s   return_51F00
                script  cs_51F88
                setFlg  FLAG_CASTLEGALAM5             ; Set after Galam and Lemon leave with their army
return_51F00:
...
Map16_ZoneEvent1:
                ...
                chkFlg  FLAG_BATTLE05_COMPLETE             ; Battle 5 completed - BATTLE_GALAM_CASTLE                 
                bne.s   return_51F26
                setSavedByte #MAP_GALAM_CASTLE, EGRESS_MAP
                chkFlg  FLAG_CASTLEGALAM6             ; Set after the Galam guards catch you sneaking around, but before battle
                bne.s   byte_51F20
                script  cs_521BA
                setFlg  FLAG_CASTLEGALAM6             ; Set after the Galam guards catch you sneaking around, but before battle
                bra.s   return_51F26
byte_51F20:
