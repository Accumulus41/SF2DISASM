...
; ASM FILE data\maps\entries\map81\mapsetups\s4_descriptions.asm :
; 0x4FCCE..0x4FD42 : 
...
ms_map81_AreaDescriptions:
    ...
    ; End of function ms_map81_AreaDescriptions

byte_4FCDE:     msDescFunction 57, 23, Map81_DescFunc0-byte_4FCDE
                msDescEnd
...
return_4FD40:
    ...
    ; End of function Map81_DescFunc0
