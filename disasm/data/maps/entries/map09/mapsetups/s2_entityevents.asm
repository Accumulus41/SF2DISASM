...
Map9_EntityEvent0:
                ...
                chkFlg  FLAG_HASSAN3             ; Set after presenting the Achilles Sword to Rohde (yes/no to the Caravan regardless)
                bne.s   byte_5682A      
                move.b  #ITEM_ACHILLES_SWORD,d1
                ...
                setFlg  FLAG_HASSAN4             ; Set after talking to Rohde in Hassan if you DON'T have the Achilles Sword?
                bra.s   loc_56828
byte_56804:
                
                chkFlg  FLAG_HASSAN4             ; Set after talking to Rohde in Hassan if you DON'T have the Achilles Sword?
                bne.s   byte_5681E
                txt     1371            ; "Yes, I'm {NAME;11}.{N}I'm really busy now.{W2}{N}Time is dear to me.{N}Please don't bother me.{W1}"
...
byte_5681E:
                ...
                script  cs_569BC
                setFlg  FLAG_HASSAN3             ; Set after presenting the Achilles Sword to Rohde (yes/no to the Caravan regardless)
loc_56828:
