...
GetBaseHp:
                ...
                getSavedCombatantWord COMBATANT_OFFSET_HP_BASE
                rts

    ; End of function GetBaseHp
...
GetMaxMp:
                ...
                getSavedCombatantWord COMBATANT_OFFSET_MP_MAX
                rts
...
GetBaseMp:
                ...
                getSavedCombatantWord COMBATANT_OFFSET_MP_BASE
                rts

    ; End of function GetBaseMp
...
GetCurrentMp:
                ...
                getSavedCombatantWord COMBATANT_OFFSET_MP_CURRENT
                rts
...
GetTotalATT:
                ...
                getSavedCombatantByte COMBATANT_OFFSET_ATT_TOTAL
                rts

    ; End of function GetTotalATT
...
GetTotalDEF:
                ...
                getSavedCombatantByte COMBATANT_OFFSET_DEF_TOTAL
                rts

    ; End of function GetTotalDEF
...
GetTotalAGI:
                ...
                getSavedCombatantByte COMBATANT_OFFSET_AGI_TOTAL
                rts

    ; End of function GetTotalAGI
