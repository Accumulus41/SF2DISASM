...
SetBaseHP:
                ...
                setSavedCombatantWord COMBATANT_OFFSET_HP_BASE
                rts

    ; End of function SetBaseHP
...
SetMaxMP:
                ...
                setSavedCombatantWord COMBATANT_OFFSET_MP_MAX
                rts
...
SetCurrentMP:
                ...
                setSavedCombatantWord COMBATANT_OFFSET_MP_CURRENT
                rts
...
SetBaseMP:
                ...
                setSavedCombatantWord COMBATANT_OFFSET_MP_BASE
                rts
...
SetTotalATT:
                ...
                setSavedCombatantByte COMBATANT_OFFSET_ATT_TOTAL
                rts

    ; End of function SetTotalATT
...
SetTotalDEF:
                ...
                setSavedCombatantByte COMBATANT_OFFSET_DEF_TOTAL
                rts

    ; End of function SetTotalDEF
...
SetTotalAGI:
                ...
                setSavedCombatantByte COMBATANT_OFFSET_AGI_TOTAL
                rts

    ; End of function SetTotalAGI
...
SetKills:
                ...
                setSavedCombatantWord COMBATANT_OFFSET_ALLY_KILLS
                rts
...
SetDefeats:
                ...
                setSavedCombatantWord COMBATANT_OFFSET_ALLY_DEFEATS
                rts
...
IncreaseBaseHP:
                ...
                clr.w   d5
                move.w  #CHAR_STATCAP_HP,d6
                moveq   #COMBATANT_OFFSET_HP_BASE,d7
                bsr.w   IncreaseAndClampWord
                movem.l (sp)+,d5-a0
                rts

    ; End of function IncreaseBaseHP
...
IncreaseCurrentMp:
                ...
                clr.w   d5
                bsr.w   GetCombatantEntryAddress
                move.w  COMBATANT_OFFSET_MP_MAX(a0),d6
...
IncreaseBaseMP:
                ...
                clr.w   d5
                move.w  #CHAR_STATCAP_MP,d6
                moveq   #COMBATANT_OFFSET_MP_BASE,d7
                bsr.w   IncreaseAndClampWord
                movem.l (sp)+,d5-a0
                rts

    ; End of function IncreaseBaseMP
...
IncreaseTotalATT:
                ...
                clr.w   d5
                move.w  #CHAR_STATCAP_ATT,d6
                moveq   #COMBATANT_OFFSET_ATT_TOTAL,d7
                bsr.w   IncreaseAndClampByte
                movem.l (sp)+,d5-a0
                rts

    ; End of function IncreaseTotalATT
...
IncreaseTotalDEF:
                ...
                clr.w   d5
                move.w  #CHAR_STATCAP_DEF,d6
                moveq   #COMBATANT_OFFSET_DEF_TOTAL,d7
                bsr.w   IncreaseAndClampByte
                movem.l (sp)+,d5-a0
                rts

    ; End of function IncreaseTotalDEF
...
IncreaseTotalAGI:
                ...
                clr.w   d5
                move.w   #CHAR_STATCAP_AGI_BASE,d6
                moveq   #COMBATANT_OFFSET_AGI_TOTAL,d7
                bsr.w   Clamp7BitIncreasing
                movem.l (sp)+,d5-a0
                rts

    ; End of function IncreaseTotalAGI
...
DecreaseBaseHP:
    ...
    ; End of function DecreaseBaseHP
...
DecreaseBaseMP:
    ...
    ; End of function DecreaseBaseMP
...
DecreaseBaseATT:
    ...
    ; End of function DecreaseBaseATT
...
DecreaseTotalATT:
    ...
    ; End of function DecreaseTotalATT
...
DecreaseTotalDEF:
    ...
    ; End of function DecreaseTotalDEF
...
DecreaseTotalAGI:
    ...
    ; End of function DecreaseTotalAGI
...
pt_EquipEffectFunctions:
                dc.l nullsub_8B22
                dc.l EquipEffect_IncreaseHP
                dc.l EquipEffect_IncreaseMP
                ...
                dc.l EquipEffect_DecreaseHP
                dc.l EquipEffect_DecreaseMP
                ...
                dc.l EquipEffect_SetHP
                dc.l EquipEffect_SetMP
                dc.l SetCurrentATT
                dc.l SetCurrentDEF
                dc.l SetCurrentAGI
                dc.l SetCurrentMOV
...
equipEffect_IncreaseCriticalProwess:
                ...
                cmpi.b  #PROWESS_CRITICAL_NONE,d2
                bcs.s   @Skip
                moveq   #PROWESS_CRITICAL150_1IN4,d2           ; cap to highest regular critical hit setting
@Skip:
...
@InBattle:
    ...
    ; End of function EquipEffect_IncreaseHP
...
@InBattle:
    ...
    ; End of function EquipEffect_IncreaseMP
...
@InBattle:
    ...
    ; End of function EquipEffect_DecreaseHP
...
@InBattle:
    ...
    ; End of function EquipEffect_DecreaseMP
...
@NoChange:
    ...
    ; End of function EquipEffect_SetHP
...
@NoChange:
    ...
    ; End of function EquipEffect_SetMP
...
InitializeCurrentStats:
                ...
                move.b  COMBATANT_OFFSET_ATT_BASE(a0),COMBATANT_OFFSET_ATT_TOTAL(a0)
                move.b  COMBATANT_OFFSET_DEF_BASE(a0),COMBATANT_OFFSET_DEF_TOTAL(a0)
                move.b  COMBATANT_OFFSET_AGI_BASE(a0),COMBATANT_OFFSET_AGI_TOTAL(a0)
...
GetEquipmentNewHPandMP:
                
                movem.l d0/d4-d6/a0,-(sp)
                bsr.w   GetCombatantEntryAddress
                clr.w   d2
                move.w  COMBATANT_OFFSET_HP_MAX(a0),d2 ; max HP
                clr.w   d3
                move.w  COMBATANT_OFFSET_MP_MAX(a0),d3 ; max MP
                movem.w d0/d2-d3,-(sp)
                move.w  #ITEMTYPE_WEAPON|ITEMTYPE_RING,d2
                clr.w   d0
                move.b  COMBATANT_OFFSET_CLASS(a0),d0
...
@Break:
                ...
                movem.l (sp)+,d1/a0
                andi.w  #ITEMTYPE_WEAPON|ITEMTYPE_RING,d2 ; get weapon/ring type
                bsr.w   GetMaxHPandMPwithSpecificItem
@Skip:
...
@Next:
                ...
                addq.w  #ITEMENTRY_SIZE,d4
                dbf     d7,@FindEquipmentLoop
                moveq   #COMBATANT_ITEMSLOTS_COUNTER,d7
                clr.w   d4
@FindEquippableItems_Loop:
                
                move.w  COMBATANT_OFFSET_ITEM_0(a0,d4.w),d5
                btst    #ITEMENTRY_BIT_EQUIPPED,d5
                beq.w   @GetNewHPandMP
                addq.w  #ITEMENTRY_SIZE,d4
                dbf     d7,@FindEquippableItems_Loop
                clr.w   d4
@GetNewHPandMP:
                ...
                bsr.w   ApplyStatusEffectsAndItemsOnStats
                clr.w   d2
                move.w  COMBATANT_OFFSET_HP_MAX(a0),d2
                clr.w   d3
                move.w  COMBATANT_OFFSET_MP_MAX(a0),d3
                movem.l (sp)+,d4-d5/a0
                movem.w d2-d3,-(sp)
...
GetEquipmentNewAGIandMOV:
                ...
                bsr.w   GetCombatantEntryAddress
                clr.w   d2
                move.b  COMBATANT_OFFSET_AGI_CURRENT(a0),d2 ; current ATT
                clr.w   d3
...
@Break:
                ...
                movem.l (sp)+,d1/a0
                andi.w  #ITEMTYPE_WEAPON|ITEMTYPE_RING,d2 ; get weapon/ring type
                bsr.w   GetCurrentAGIandMOVwithSpecificItem
@Skip:
...
GetCurrentAGIandMOVwithSpecificItem:
...
@GetNewAGIandMOV:
                ...
                bsr.w   ApplyStatusEffectsAndItemsOnStats
                clr.w   d2
                move.b  COMBATANT_OFFSET_AGI_CURRENT(a0),d2
                clr.w   d3
                move.b  COMBATANT_OFFSET_MOV_CURRENT(a0),d3
                movem.l (sp)+,d4-d5/a0
                movem.w d2-d3,-(sp)
                move.w  d5,COMBATANT_OFFSET_ITEM_0(a0,d4.w) ; and unequip
                bsr.w   ApplyStatusEffectsAndItemsOnStats
